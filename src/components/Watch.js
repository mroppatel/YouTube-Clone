...
const Watch = () => {
  ...
  useEffect(() => {
    getSingleVideo(); // eslint-disable-next-line
  }, []);
        ...
        <div className="w-[100%] border border-gray-300 ml-8 rounded-lg h-fit p-4">
          ...
          <div className="flex items-center justify-between border-t p-2">
            <div className="flex items-center w-[90%]">
              ...
              <input value={input} onChange={(e)=>setInput(e.target.value)} className="border-b border-gray-300 outline-none ml-2" type="text" placeholder="Send massage ... "/>
              <div className="bg-gray-200 cursor-pointer p-2 rounded-full">
                <LuSendHorizonal onClick={sendMassage}/>
              </div>
            </div>
          </div>
        </div>
